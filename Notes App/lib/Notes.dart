  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: noteHeading.length > 0
          ? buildNotes()
          : Center(child: Text("Добавить заметку...")),
                      ...
                      TextFormField(
                        ...
                        validator: (String noteHeading) {
                          if (noteHeading.isEmpty) {
                            return "Пожалуйста, введите заголовок примечания";
                          } else if (noteHeading.startsWith(" ")) {
                            return "Пожалуйста, избегайте пробелов";
                          }
                        },
                          ...
                          child: TextFormField(
                            ...
                            validator: (String noteDescription) {
                              if (noteDescription.isEmpty) {
                                return "Пожалуйста, введите примечание";
